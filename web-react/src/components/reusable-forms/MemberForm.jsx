    ...
    <div className="row row-cols-1">
      ...
      <div className="col my-3">
        ...
        <p className="text-center text-danger">
          <small>Please note that * are required to submit the form</small>
        </p>
        ...
        <div className="form-row">
          ...
          <div className="col-10">
            <small htmlFor="dateofbirth" className="form-text ">
              Date of Birth* <i className="text-secondary">(Day/Month/Year)</i>
            </small>
            <FormikControl
              className="form-control"
              control="input"
        ...
        <div className="col my-4">
          ...
          <FieldArray name="pastoralAppointment">
            {(fieldArrayProps) => {
              ...
              return (
                <div>
                  {pastoralAppointment.map((pastoralAppointment, index) => (
                    <div key={index} className="form-row">
                      ...
                      <div className="col d-flex">
                        {index > 0 && <MinusSign onClick={() => remove()} />}
                      </div>
                    </div>
                  ))}
                </div>
