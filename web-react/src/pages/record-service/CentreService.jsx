...
import { RECORD_CENTRE_SERVICE } from './RecordServiceMutations'
...
const CentreService = () => {
  ...
  const [RecordCentreService] = useMutation(RECORD_CENTRE_SERVICE)
  ...
  return (
    <>
      <NavBar />
      <ServiceForm
        RecordServiceMutation={RecordCentreService}
